...
$sql2 = "SELECT * FROM room_details WHERE id = $id";
$stmt = $conn->prepare($sql2);
$stmt->execute();
$room_details2 = $stmt->fetchAll(PDO::FETCH_CLASS);

$sql2 = "SELECT room_details.id, gallery.image FROM room_details INNER JOIN gallery ON room_details.id = gallery.id_room WHERE id_room=$id";
$stmt = $conn->prepare($sql2);
$stmt->execute();
...
<!-- Mirrored from premiumlayers.net/demo/html/hotelbooking/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 15:33:43 GMT -->
                ...
                <div class="other_room">
                    <div role="tabpanel">
                            ...
                            <div class="section_title">
                                <ul class="nav nav-tabs margin-bottom-60" role="tablist">
                                    <?php foreach ($room_details2 as $r) : ?>
                                        <li role="presentation" class="active"><a href="" aria-controls="all" role="tab" data-toggle="tab"><?= $r->name ?></a></li>
                                    <?php endforeach; ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="?id=<? $r->id ?>">
                                                                ...
                                                                <div id="gallery_main_slider" class="carousel slide" data-ride="carousel">
                                                                    ...
                                                                    <div class="carousel-inner" role="listbox">
                                                                        <div class="item active">
                                                                            <?php foreach ($room_details2 as $room) : ?>
                                                    ...
                                                    <div class="single_room_wrapper clearfix">
                                                        <div class="room_wrapper">
                                                            <div class="room_media">
                                                                ...
                                                                <a href="<?= $img->image ?>"><img alt="img" src="<?= $img->image ?>"></a>
...
<!-- Mirrored from premiumlayers.net/demo/html/hotelbooking/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Mar 2020 15:33:48 GMT -->
